...
extension SkeletonCell {
    ...
    private func layout() {
        ...
        underlineView.trailingAnchor.constraint(equalTo: typeLabel.trailingAnchor).isActive = true
        ...
        balanceStackView.topAnchor.constraint(equalToSystemSpacingBelow: underlineView.bottomAnchor, multiplier: 0).isActive = true
